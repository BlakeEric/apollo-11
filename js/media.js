...
var media = function () {
  ...
  */
  function pluckMediaFromDom() {
    var mediaElems = document.querySelectorAll('figure.video, figure.audio');
    var mediaData = {};
    mediaElems.forEach(function (item) {
      //Remove item from the DOM
      item.parentNode.removeChild(item); //Create controls and slap them onto the node
  ...
  */
  function playItem(id) {
    ...
    var itemToPlay = state.queue.find(function (item) {
      return item.id == id;
    });
  ...
  */
  function pauseItem(id) {
    ...
    var itemToPause = state.queue.find(function (item) {
      return item.id == id;
    });
  ...
  */
  function addToQueue(id) {
    ...
    if (state.queue.find(function (item) {
      return item.id === id;
    })) {
